<!-- HƯỚNG DẪN: Xóa sạch toàn bộ file README.md cũ trên GitHub, dán toàn bộ nội dung từ dòng này trở xuống rồi bấm Commit changes -->
...
### 2. Khởi chạy game:
* **Cách 1 (Nhanh nhất trên Windows):** Click đúp chuột vào file `run_game.bat`.
* **Cách 2 (Dòng lệnh):**
```bash
